package com.zhuzichu.module_base.widget.materialintro.view;
...
import com.zhuzichu.module_base.widget.materialintro.MaterialIntroConfiguration;
import com.zhuzichu.module_base.widget.materialintro.animation.AnimationFactory;
import com.zhuzichu.module_base.widget.materialintro.animation.AnimationListener;
import com.zhuzichu.module_base.widget.materialintro.animation.MaterialIntroListener;
import com.zhuzichu.module_base.widget.materialintro.prefs.PreferencesManager;
import com.zhuzichu.module_base.widget.materialintro.shape.Circle;
...
import com.zhuzichu.module_base.widget.materialintro.shape.Rect;
import com.zhuzichu.module_base.widget.materialintro.shape.Shape;
import com.zhuzichu.module_base.widget.materialintro.shape.ShapeType;
import com.zhuzichu.module_base.widget.materialintro.target.Target;
import com.zhuzichu.module_base.widget.materialintro.target.ViewTarget;
import com.zhuzichu.module_base.widget.materialintro.utils.Constants;
import com.zhuzichu.module_base.widget.materialintro.utils.Utils;
...
public class MaterialIntroView extends RelativeLayout {
    ...
    private void showOnce(Activity activity) {
    ...
    private void setIconColor(int color){
        this.imageViewIcon.setColorFilter(color);
    }
    ...
    public static class Builder {
        ...
        public Builder setIconColor(int color) {
            materialIntroView.setIconColor(color);
            return this;
        }
        ...
        public MaterialIntroView showOnce() {
            build().showOnce(activity);
            return materialIntroView;
        }
    }
