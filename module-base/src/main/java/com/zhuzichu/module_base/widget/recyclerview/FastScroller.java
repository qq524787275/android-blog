package com.zhuzichu.module_base.widget.recyclerview;
...
import com.zhuzichu.module_base.utils.ListenerUtil;
...
class FastScroller {
    ...
    public FastScroller(Context context, FastScrollRecyclerView recyclerView, AttributeSet attrs) {
        ...
        mThumbHeight = DensityUtils.dip2px(context, 48);
        mWidth = DensityUtils.dip2px(context, 8);

        mTouchInset = DensityUtils.dip2px(context, -24);
        ...
        try {
            ...
            int popupTextSize = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupTextSize, DensityUtils.dip2sp(context,56));
            int popupBackgroundSize = typedArray.getDimensionPixelSize(R.styleable.FastScrollRecyclerView_fastScrollPopupBackgroundSize, DensityUtils.dip2px(context,88));
