...
import com.zhuzichu.module_base.widget.banner.listener.OnBannerClickListener;
import com.zhuzichu.module_base.widget.banner.listener.OnBannerListener;
import com.zhuzichu.module_base.widget.banner.loader.ImageLoaderInterface;
import com.zhuzichu.module_base.widget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private OnChangeBitmapListener mBitmapListener;
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    public void setOnChangeBitmapListener(OnChangeBitmapListener mBitmapListener) {
