...
public class GlobalGlideConfig extends AppGlideModule {
    ...
    public static void forget(String url) {
        GlobalGlideConfig.DispatchingProgressListener.forget(url);
    }

    public static void expect(String url, UiOnProgressListener listener) {
        GlobalGlideConfig.DispatchingProgressListener.expect(url, listener);
    }
    ...
    private static class DispatchingProgressListener implements GlobalGlideConfig.ResponseProgressListener {
